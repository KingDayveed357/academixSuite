      ...
      <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-3 lg:justify-end">
          ...
          <div className="relative inline-flex w-full items-center sm:w-auto">
            ...
            <input
              ref={datePickerRef}
              className="h-10 w-full rounded-lg border border-gray-200 bg-white pl-10 pr-3 py-2 text-sm font-medium text-gray-700 outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 sm:w-40"
